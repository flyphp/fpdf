...
*                                                                              *
*                                                                              *
* Importado para o projeto por Allan Freitas @allanfreitas                     *
*******************************************************************************/

class Fpdf
{
	//Public properties
	//@Refazer chamando através de uma função.
	public  $CurOrientation;     //current orientation

	//precisou alterar pra protected
		...
		switch($dest)
		{
			case 'I':
				...
				if(php_sapi_name()!='cli')
				{
					...
					if(headers_sent($name,$linenumber))
						$this->Error('Some data has already been output to browser '.$name.' '.$linenumber.', can\'t send PDF file');
